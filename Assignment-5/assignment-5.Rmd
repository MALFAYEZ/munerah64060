...
In this part, we shall be using AGNES to compare the clustering from single linkage, complete 
linkage, average linkage, and Ward. We shall choose the best method.
